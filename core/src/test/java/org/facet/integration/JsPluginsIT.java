...
class JsPluginsIT {
    ...
    @Container
    private static final GenericContainer<?> RESTHEART = new GenericContainer<>(DockerImageName.parse("facet-test:latest"))
            .withNetwork(NETWORK)
            .dependsOn(MONGO)
            ...
            .withCopyFileToContainer(
                    MountableFile.forHostPath("../examples/product-catalog/plugins/product-stats"),
                    "/opt/restheart/plugins/product-stats/")
            .withCopyFileToContainer(
                    MountableFile.forHostPath("../examples/product-catalog/plugins/request-logger"),
                    "/opt/restheart/plugins/request-logger/")
            .withCopyFileToContainer(
                    MountableFile.forHostPath("../examples/product-catalog/templates"),
                    "/opt/restheart/templates/")
            .withCopyFileToContainer(
                    MountableFile.forHostPath("../examples/product-catalog/restheart.yml"),
                    "/opt/restheart/etc/restheart.yml")
            .withCopyFileToContainer(
                    MountableFile.forHostPath("../examples/product-catalog/users.yml"),
